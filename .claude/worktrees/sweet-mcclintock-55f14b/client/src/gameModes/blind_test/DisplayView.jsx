...
export default function BlindTestDisplayView({ step, state }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Reveal: correct answer for text mode */}
      {status === 'answer_revealed' && !hasChoices && (
      ...
      {status === 'answer_revealed' && hasChoices && step?.explanation && (
